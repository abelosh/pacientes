...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Atención al Usuario">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Edvin Letona">
  ...
  <div id="divLoading" >
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Atención al Usuario</a>
